<table class="statisticsbox">
             <tr>
                ...
                <?php 
                    // DATe
                    $stmt = $con->prepare("SELECT hifz,muraja,date,hifz,hifztasmee3,wird_id,isPLus FROM wird_two WHERE user_id = '$user_id'");
                    $stmt->execute();
        ...
        <!-- احصائيات المراجعة -->
         ...
         <table class="statisticsbox">
             <tr>
                ...
                <?php 
                    $stmt = $con->prepare("SELECT hifz,muraja,date,hifz,murajatasmee3,isPLus FROM wird_two WHERE user_id = '$user_id'");
                    $stmt->execute();
