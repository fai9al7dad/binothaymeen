<form action="<?php $_SERVER['PHP_SELF'] ?>" method = "POST">
    ...
    <div class="reading">
        <p>القراءة</p>
        <div class="boxcontainer">
            <label for ="reading">كم قرأت اليوم؟</label>
            <input onkeypress="return onlyNumberKey(event)" name = "reading"  id ="reading" value="0" type="number"  required autocomplete ="off" step="0.5" min=0>
        </div>
    </div>
